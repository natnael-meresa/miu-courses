...
public class Prog2 {
    void main() {
        ...
        String[] productIds = extractProductCode(records);
        System.out.println("List of product ids:  ");
        for (String id: productIds) {
            System.out.println(id);
        }
    }

    String[] extractProductCode(String records) {
        String[] arr1 = records.split(":");
        String[] arr2 = new String[arr1.length];
        for (int i = 0; i < arr1.length; i++) {
            arr2[i] = arr1[i].split(",")[0];
        }
